const pageSidebar = [
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            type: 'ref',
            id: 'create/guides/my-first-dapp/start',
            href: 'docs/create/guides/my-first-dapp/start',
      ...
      },
      {
        ...
        items: [
          ...
          { type: 'ref', id: 'create/cli/developer-cli', href: 'docs/create/cli/developer-cli', label: 'Developer CLI' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        type: 'ref',
        id: 'validator/running-a-validator-node',
        href: 'docs/validator/running-a-validator-node',
        label: 'Running a Validator Node',
      },
      { type: 'ref', id: 'validator/monitoring-validators', href: 'docs/validator/monitoring-validators', label: 'Monitoring Validators' },
      {
        ...
        href: 'docs/validator/troubleshooting',
        label: 'Troubleshooting Common Issues With Validator Nodes',
      },
    ],
  },
  {
