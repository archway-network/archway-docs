...
function Footer() {
  ...
  return (
    <footer className="footer" data-v-26b507a6><div className="bg-dark tm-text" data-v-26b507a6>
      <div className="footer-top tm-container" data-v-26b507a6>
        <div className="footer-top__container" data-v-26b507a6>
          <div className="tm-rf7 tm-lh-title" data-v-26b507a6>Arch into Cosmos</div>
            ...
            <div className="footer-top__row tm-rf2 tm-rf1-m-up" data-v-26b507a6>
              <div className="footer-top__col" data-v-26b507a6>
                <ul className="footer-top__list" data-v-26b507a6>
                  <li className="tm-rf2 tm-rf1-m-up tm-overline tm-medium" data-v-26b507a6>
                    <span className="footer-top__list-title" data-v-26b507a6>Archway</span>
                  </li>
                  <li data-v-26b507a6>
                    <a href="https://docs.archway.io/docs/overview/about" target="_blank" rel="noopener noreferrer" className="ft-link footer-top__link tm-link" data-v-78aa3c22 data-v-26b507a6>About</a>
                  </li>
                  <li data-v-26b507a6>
              ...
              <div className="footer-top__col" data-v-26b507a6>
                <ul className="footer-top__list" data-v-26b507a6>
                  <li className="tm-rf2 tm-rf1-m-up tm-overline tm-medium" data-v-26b507a6>
                    <span className="footer-top__list-title" data-v-26b507a6>Community</span>
                  </li>
                  <li data-v-26b507a6>
                    <a href="https://blog.archway.io" target="_blank" rel="noopener noreferrer" className="ft-link footer-top__link tm-link" data-v-78aa3c22 data-v-26b507a6>Blog</a>
                  </li>
                  <li data-v-26b507a6>
                    <a href="https://discord.gg/archwayhq" target="_blank" rel="noopener noreferrer" className="ft-link footer-top__link tm-link" data-v-78aa3c22 data-v-26b507a6>Discord</a>
                  </li>
                  <li data-v-26b507a6>
                    <a href="https://twitter.com/archwayhq" target="_blank" rel="noopener noreferrer" className="ft-link footer-top__link tm-link" data-v-78aa3c22 data-v-26b507a6>Twitter</a>
                  </li>
                </ul>
              </div>
              <div className="footer-top__col" data-v-26b507a6>
          ...
          <div className="mt-9 back-to-top" data-v-26b507a6>
            <a id="sctoparw" href="#" className="tm-rf0 tm-rf-1-m tm-muted scrolltop tm-link" data-v-78aa3c22 data-v-26b507a6 onClick={() => {document.querySelector('div').scrollTo(0,0);document.querySelector('body').scrollTo(0,0);}}>
      ...
      <div className="footer-bottom tm-rf-1 tm-lh-copy tm-text tm-inter" data-v-26b507a6>
