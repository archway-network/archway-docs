    ...
    <Layout className={styles.Layout}>
      ...
      <section className={styles.features}>
        <div className={styles.fdbackp}>
          <img src="../img/universe/the-virtuous-feedback-loop.jpg" className={styles.fdback} />
        </div>
      </section>
      ...
      <section className={styles.features}>
        <div className={styles.fdbackp}>
          <img src="../img/universe/archway-universe.jpg" className={styles.fdback} />
        </div>
      </section>
      ...
      <section className={styles.featuresm}>
        <div className="container">
          <div className="hero hero--primary">
            ...
            <div className="row-f">
              <div className="text--center">
                <img src="../img/lk-6.svg" className={styles.featureSvg} />
              </div>
            </div>
          </div>
        </div>
