...
The first step is to run a node. See the [Node Installation](../node/install.md) and [Joining a Network](../node/join-a-network.md) docs for instructions on how to get your node up and running.
