...
<template>
  <div class="grid pb-16">
    ...
    <Link
      href="/developers/cosmwasm-documentation/introduction"
...
<style scoped>
  .grounded-radiants::after {
    ...
    left: -4px;
    right: -4px;
    background: linear-gradient(144.94deg, #fcecb2 10.14%, #ff8b89 30.97%, #fc8adc 51.8%, #7954ff 70.54%, #70bcff 90.12%);
    content: '';
    z-index: -1;
    border-radius: 16px;
  }
