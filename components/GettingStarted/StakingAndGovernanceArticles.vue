  ...
  const articles: Article[] = [
    {
      ...
      path: '/community/wallet-setup/overview',
    },
    {
      id: 'community_send-tokens',
...
<template>
  <ArticlesSection title="Staking and Governance" :articles="articles" />
</template>
