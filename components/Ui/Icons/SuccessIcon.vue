<template>
  <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_4393_24181)">
      ...
      />
      <path d="M14.5 3L8 9.5L6 7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </g>
    <defs>
      <clipPath id="clip0_4393_24181">
        <rect width="16" height="16" fill="white" />
      </clipPath>
    </defs>
  </svg>
