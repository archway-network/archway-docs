...
8. Create the IBC transfer message with the necessary parameters. You can find the source channels for Archway's supported IBC Conections, [here](/resources/ibc-channels#constantine-testnet):
