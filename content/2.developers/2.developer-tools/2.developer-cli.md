...
Archway's Developer CLI helps you to build,deploy, configure, instantiate, query and interact with smart contracts. You can take a look at the and  <a href="https://github.com/archway-network/archway-cli" target="_blank" >Github repository here</a> 

You can install the Archway developer CLI using **npm** with:
