...
```bash
archwayd q rewards rewards-records archway12reqvcenxgv5s7z96pkytzajtl4lf2epyfman2 --node https://rpc.constantine-1.archway.tech:443 --chain-id constantine-3 --output json | jq .
```
