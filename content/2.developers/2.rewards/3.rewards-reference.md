...
```bash
archwayd tx rewards withdraw-rewards --chain-id "archway-1" --node "http://rpc.mainnet.archway.io/" --records-limit 100 --from mywallet --gas auto --gas-prices 0.05aarch --gas-adjustment 1.4 --broadcast-mode sync --output json -y
```
::
