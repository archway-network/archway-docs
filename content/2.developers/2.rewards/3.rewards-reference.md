...
```
archwayd tx rewards withdraw-rewards --chain-id "constantine-3" --node "https://rpc.constantine.archway.tech:443" --records-limit 100 --from mywallet --gas auto --gas-prices 0.05uconst --gas-adjustment 1.4 --broadcast-mode sync --output json -y
```
## Flags
