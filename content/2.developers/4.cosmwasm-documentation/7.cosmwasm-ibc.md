...
As an example, let's look into how to implement a simple IBC counter smart contract with CosmWasm. You can find the code for this example in this github repository <a href="https://github.com/0xekez/cw-ibc-example" target="_blank">Github repository</a>.
