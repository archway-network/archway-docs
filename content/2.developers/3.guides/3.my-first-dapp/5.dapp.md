...
const ChainInfo = {
  ...
  stakeCurrency: { coinDenom: 'CONST', coinMinimalDenom: 'aconst', coinDecimals: 6 },
  bip44: { coinType: 118 },
  bech32Config: {
  ...
  currencies: [{ coinDenom: 'CONST', coinMinimalDenom: 'aconst', coinDecimals: 6 }],
  feeCurrencies: [{ coinDenom: 'CONST', coinMinimalDenom: 'aconst', coinDecimals: 6 }],
  coinType: 118,
