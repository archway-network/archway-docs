...
In the case of using **archwayd**, you need to add the the **Code Id** (which you can see by looking at the **store** tx data and set the **admin** address. You can check that information and the contract address on a [blockeplorer](/resources/blockexplorers)).
