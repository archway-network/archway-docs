...
```bash
archwayd tx wasm store artifacts/test_project2.wasm --from my-wallet --node https://rpc.constantine.archway.tech:443 --chain-id constantine-3 --gas 5000000 --fees 8000uconst
```
...
```bash
archwayd tx wasm instantiate 795 '{"count":0}' --from my-wallet --node https://rpc.constantine.archway.tech:443 --chain-id constantine-3 --gas 5000000 --fees 8000uconst --label testdev --admin archway1c23y29x9fcs4zlfv5tvl4nrq56p6gywq0snrxl
```
