...
As we saw in the previous guide, to query a contract we need to know its address on chain. We also need an instance of **SigningCosmWasmClient** from <a href="https://www.npmjs.com/package/@cosmjs/cosmwasm-stargate" target="_blank" >@cosmjs/cosmwasm-stargate</a> that's connected to an Archway network such as <a href="https://rpc.constantine.archway.tech/" target="_blank" >Constantine testnet</a>.
