...
```bash
archwayd tx wasm execute --chain-id constantine-3 --gas 5000000 --fees 8000aconst archway19tj3m5rnspptlyjellxr7hqp9n7szym3wmgxs5g60guk64gpeaqq4r3h5c '{"transfer_nft":{"recipient":"archway1y00hm50lffnxt5m0kuy9afk83gyuye684zwcr5","token_id":"1"}}' --from my-wallet --node https://rpc.constantine.archway.io:443
```
