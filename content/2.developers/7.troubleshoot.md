...
If using the Developer CLI v1, you can try using the [Developer CLI v2](/developers/developer-tools/developer-cli/developer-cli) instead,does not have any dependency on *archwayd*. Also, the CLI v2 provides additional features with a smoother development cycle. 
...
You can use the [Developer CLI](/developers/developer-tools/developer-cli/developer-cli), choose the *CW20* template and set the following parameters in the 
