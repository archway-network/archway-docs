...
This command-line interface tool provides a suite of commands that makes it a lot easier to interact with the Archway blockchain, including project setup, contract deployment, and interaction. To install the Archway Developer CLI via npm, execute the following command in your terminal:
