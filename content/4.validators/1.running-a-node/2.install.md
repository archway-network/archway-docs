...
```bash
nano /etc/systemd/system/archwayd_s.service
...
sudo -S systemctl enable archwayd_s
```
...
sudo systemctl start archwayd_s
```
...
sudo systemctl status archwayd_s
```
...
```bash
nano /etc/systemd/system/archwayd_ds.service
...
sudo -S systemctl enable archwayd_ds
```
...
sudo systemctl start archwayd_ds
```
...
sudo systemctl status archwayd_ds
```
