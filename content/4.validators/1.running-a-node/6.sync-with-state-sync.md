...
```toml
rpc_servers = "https://rpc.constantine-2.archway.tech:443"
```
...
```
SNAP_RPC= https://rpc.constantine-2.archway.tech:443
```
...
archwayd start \
  ...
  --p2p.seeds e5e4a459b85e7bd3f1769e08b7f488b9d0648844@104.154.204.236:26656 --unsafe-skip-upgrades 1492500
```
::
