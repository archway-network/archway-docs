...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.1 init <moniker> --chain-id <chain>
```
...
```bash
docker run -v ${HOME}/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.1  init my-cool-moniker --chain-id archway-1
```
...
```bash
docker run -v ${HOME}/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.1  init my-cool-moniker --chain-id constantine-3
```
