...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 keys add <account-name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 keys add my-node
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 \
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 keys show <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 keys delete <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v4.0.0 keys export <key_name>
```
