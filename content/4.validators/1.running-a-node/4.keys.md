...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:$$archwayVersion$$ keys add <account-name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:$$archwayVersion$$ keys add my-node
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:$$archwayVersion$$ keys show <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:$$archwayVersion$$ keys delete <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:$$archwayVersion$$ keys export <key_name>
```
