...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.0-rc.3 keys add <account-name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.0-rc.3 keys add my-node
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.0-rc.3 keys show <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.0-rc.3 keys delete <key_name>
```
...
```bash
docker run --rm -it -v ~/.archway:/root/.archway ghcr.io/archway-network/archwayd:v1.0.0-rc.3 keys export <key_name>
```
