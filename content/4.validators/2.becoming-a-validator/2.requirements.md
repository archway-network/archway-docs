...
We expect that a modest level of hardware specifications is initially needed and might rise as network use increases. Participating in the testnet is the best way to learn more. See [Hardware Requirements](/validators/running-a-node/prerequisites#hardware-requirements) for more details.
