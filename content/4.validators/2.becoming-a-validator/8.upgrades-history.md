...
- **Version**: $$archwayVersion$$
- **Type**: Network Upgrade
- **Time**: TBD
- **Motivation**: Enable ICAHost and fix authz msg decoding in x/rewards antehandlers
- **Release**: https://github.com/archway-network/archway/releases/tag/$$archwayVersion$$
- **Changelog**: https://github.com/archway-network/archway/blob/$$archwayVersion$$/CHANGELOG.md
