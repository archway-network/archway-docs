...
coins\":[{\"denom\":\"aarch\",\"amount\":\"100000000000000\"}]},{\"address\":\"ar
chway195uq5lz84udvc8u5hxr4jsp0eg6x54a2jmq3zv\",\"coins\":[{\"denom\":\"aarch\",\"amount\":\"100000000000000\"}]}]|" ./node1/config/genesis.json
```
::
...
```bash
archwayd add-genesis-account $(archwayd keys show node1-account -a --home ./node1) 1000000000aarch --home ./node1
```
...
```bash
archwayd add-genesis-account $(archwayd keys show node1-account -a --home ./node2) 1000000000aarch --home ./node1
```
...
::highlight-card
```bash
archwayd gentx node1-account 1000000000aarch --chain-id my-chain --home ./node1
