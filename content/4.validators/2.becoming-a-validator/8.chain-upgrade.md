...
Upgrading your node during soft forks and hard forks, as well as when using [Cosmovisor](/validators/running-a-node/cosmovisor) or not, may involve different processes. Here are the key differences between these scenarios:
