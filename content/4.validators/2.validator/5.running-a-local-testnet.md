...
To have a working test network we need at least 2 validator nodes. So, let's create them

## Create the required directories

To have a working test network we need at least 2 validator nodes.
