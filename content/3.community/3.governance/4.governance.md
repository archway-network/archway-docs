...
--node 
https://rpc.constantine.archway.tech:443 --chain-id constantine-3 --fees 500aconst`
...
--description 
"test2" --from mywallet5 --chain-id constantine-3 --fees 500aconst`
...
--chain-id constantine-3 --fees 500aconst --proposal=/root/archway/proposals/testproposal.json`
...
1. `--fees` is a flat-rate incentive for a validator to process your transaction
   ...
   1. For example, you could use `--fees 500aconst` (which is equal to 0.0001 CONST)
