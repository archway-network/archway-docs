...
```json
{
   ...
   "description":"constantine-2 is a test network, with a goal to emulate mainnet as closely as possible. However, inorder to allow 
testability 
...
The Community can vote either via the CLI or via the <a href="https://explorer.constantine-2.archway.tech/proposals" target="_blank">Constantine blockexplorer</a>. 
