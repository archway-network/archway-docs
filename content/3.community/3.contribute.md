...
You can find the Archway docs in the [Archway docs repository](https://github.com/archway-network/archway-docs/tree/main)
...
- Using [Node and npm](https://nodejs.org/en/download/)
...
3. Building the Archway docs website requires [Node and npm](https://nodejs.org/en/download/) for JavaScript.

::alert{variant="success"}
For running [Nuxt 3](https://nuxt.com/) we recommend using Node version 14 (fermium). 
...
4. Using [npm](https://www.npmjs.com/), install the repository's dependency modules
   ::highlight-card
