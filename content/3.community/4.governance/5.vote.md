...
The easiest way to vote on governance proposals is through [Archway Connect](/community/archway-connect). Anyways, you can vote on governance proposals also via a [wallet](wallet.md) or the [archwayd](../developers/developer-tools/daemon) directly.
...
Look at the governance proposals that are in the **Voting** phase, and click on it.
![](/images/docs/ac_vote_4.png)

Read at the governance proposal's details,and click on **Vote**:
