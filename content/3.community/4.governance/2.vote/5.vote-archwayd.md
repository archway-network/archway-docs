...
```bash
archwayd q gov proposals https://rpc.constantine.archway.io:443 --chain-id constantine-3
```
...
```bash
archwayd tx gov vote 28 yes --from mywallet --node https://rpc.constantine.archway.io:443 --chain-id constantine-3
