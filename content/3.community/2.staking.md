...
Make sure to check the [wallet section](wallet), install - <a href="https://wallet.keplr.app/" target="_blank">Keplr</a>, and deposit some funds beforehand.
...
## **Staking via Cosmostation**


### Prerequisites

Make sure to check the [wallet section](wallet) and install <a href="https://wallet.cosmostation.io/cosmos" target="_blank">Cosmostation</a>. Afterwards, don't forget to deposit some tokens into your account.
### **Delegating**
