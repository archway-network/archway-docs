...
### **Contributions**
Some validators may run additional services such relayers, blockexplorers or other tools. Supporting these contributors is key for the success of a healthy ecosystem.
...
In order to delegate your stake you have to either [run your node](/validators/running-a-validator-node) or you can connect to a trustworthy operator.
