...
| :---------------------: | :----------: | :------------: |
|  Speed of development   |      	:x:       |       :heavy_check_mark:	       |
|   Ease of development   |      	:x:       |       :heavy_check_mark:	        |
|   Complexity of logic   |      :heavy_check_mark:	       |       :heavy_check_mark:	        |
|  Maintenance overhead   |      	:x:       |       :heavy_check_mark:	        |
| Level of customization  |      :heavy_check_mark:	       |       	:x:        |
| Strict resource control |      	:x:       |       :heavy_check_mark:	        |
|  Native chain features  |      :heavy_check_mark:	       |       	:x:        |
