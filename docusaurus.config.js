    ...
    pageCategories: [
      {
        ...
        children: [
          {
            name: 'Quick Start',
            value: '/docs/create/getting-started/install',
            icon: 'icon-rocket',
            description: 'Get started building decentralized applications on Archway',
          },
          {
            name: 'Guides',
            value: '/docs/create/guides/launchpad',
            icon: 'icon-guide2',
            description: 'Dive deeper into Archway smart contract development and dApp client code',
          },
          {
            name: 'Videos',
            value: '/videos',
            icon: 'icon-video3',
            description: 'Code along side Archway developers using our video tutorials',
          },
          {
            name: 'Dependencies',
            value: '/docs/create/advanced/cargo',
            icon: 'icon-beta1',
            description: 'Update your source code and manage dependencies',
          },
          {
            name: 'Debugging',
            value: '/docs/create/advanced/debug',
            icon: 'icon-bug',
            description: 'Tricks and tips for debugging smart contract errors',
          },
          {
            name: 'Troubleshooting',
            value: '/docs/create/advanced/troubleshooting',
            icon: 'icon-fix2',
            description: 'Troubleshoot common issues and problems with Archway development',
          },
          {
            name: 'Core Protocol',
            value: '/docs/create/cli/daemon',
            icon: 'icon-computer',
            description: "Learn about the archwayd binary from a developer's perspective",
          },
          {
            name: 'CLI Basics',
            value: '/docs/create/cli/developer-cli',
            icon: 'icon-guide1',
            description: 'Usage instructions and documentation for the Developer CLI',
          },
        ],
      },
      {
        ...
        children: [
          ...
          [
            {
              name: 'Install',
              value: '/docs/node/install',
              icon: 'icon-hdd',
              description: 'Installation requirements for Archway node operators',
            },
            {
              name: 'Configure',
              value: '/docs/node/configure',
              icon: 'icon-settings',
              description: 'Node configurations and operator settings',
            },
            {
              name: 'Run a local testnet',
              value: '/docs/node/running-a-local-testnet',
              icon: 'icon-experiments',
              description: 'Running local testnet nodes',
            },
            {
              name: 'Joining a network',
              value: '/docs/node/join-a-network',
              icon: 'icon-sitemap',
              description: 'Join an existing Archway network such as Augusta, Constantine or Titus',
            },
          ],
          // Validators
          [
            {
              name: 'What are validators?',
              value: '/docs/validator/overview',
              icon: 'icon-safe1',
              description: 'Learn about validators and how they keep Archway secure',
            },
            {
              name: 'Requirements',
              value: '/docs/validator/requirements',
              icon: 'icon-download1',
              description: 'Installation requirements for validator nodes',
            },
            {
              name: 'Run a validator node',
              value: '/docs/validator/running-a-validator-node',
              icon: 'icon-sitemap',
              description: 'Running your validator and earning rewards',
            },
            {
              name: 'Monitor validators',
              value: '/docs/validator/monitoring-validators',
              icon: 'icon-monitor',
              description: 'Enable monitoring services to help ensure continuous uptime',
            },
            {
              name: 'Troubleshoot',
              value: '/docs/validator/troubleshooting',
              icon: 'icon-fix2',
              description: 'Troubleshoot common problems with validator nodes',
            },
          ],
        ],
      },
        ...
        children: [
          {
            ...
            value: '/docs/participate/wallet',
            icon: 'icon-wallet',
            description: 'Setup a new account to begin receiving and sending coins',
          },
          { name: 'Staking', value: '/docs/participate/staking', icon: 'icon-pig', description: 'Enroll your account in staking rewards' },
          {
            name: 'Contributing',
            value: '/docs/participate/contribute',
            icon: 'icon-build',
            description: 'Help maintain and support Archway documentation and guides',
          },
        ],
      },
      {
